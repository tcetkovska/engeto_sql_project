...
SELECT 
	...
	round(ttca.average_price/ttca2.average_price,2)-1 AS yoy_perc_change_price,
	round(ttca.average_wage/ttca2.average_wage,2)-1 AS yoy_perc_wage,
	round(ttca.GDP/ttca2.GDP,2)-1 AS yoy_perc_change_GDP
